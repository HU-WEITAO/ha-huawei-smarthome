"""Product adapter for Huawei SmartLock 2 Ultra (KW5N).

华为智能门锁 2 Ultra - 全功能接入 Home Assistant
"""
...
class ProductKW5NAdapter:
    """Huawei SmartLock 2 Ultra (KW5N) adapter for Home Assistant."""
